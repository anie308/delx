...
function HomeHero() {
  return (
    <div className='bg-gradient-to-l from-green-100 dark:md:from-green-900 md:from-green-100 to-green-100 h-full md:h-[450px] w-full gap-3 flex flex-col md:flex-row items-center justify-between p-[15px] md:p-[20px_40px] transition duration-500'>
