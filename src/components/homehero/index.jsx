...
function HomeHero() {
  return (
    <div className='h-full md:h-[400px] w-full gap-3 flex flex-col md:flex-row items-center justify-between p-[15px] md:p-[20px_40px]'>
      ...
      <div className='flex-1 bg-green-300 h-full'>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Voluptatum corrupti saepe, et tempora dolore, odit ut reiciendis hic facilis numquam eligendi maxime adipisci esse mollitia impedit accusamus sit officiis ea.</div>
    </div>
  )
}
