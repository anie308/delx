...
function HomeHero() {
  return (
    <div className='bg-gradient-to-r from-yellow-50 to-yellow-200 h-full md:h-[400px] w-full gap-3 flex flex-col md:flex-row items-center justify-between p-[15px] md:p-[20px_40px]'>
